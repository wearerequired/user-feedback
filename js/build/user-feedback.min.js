/*! user-feedback - v1.0.0 - 2015-02-24 */
...
try{delete a[h]}catch(d){}i.parentNode.removeChild(i),i=null,delete g.script,delete g.callbackname},i.setAttribute("type","text/javascript"),i.setAttribute("src",j),g.script=i,a.document.body.appendChild(i)}function h(b,c){var d=a.getComputedStyle(b,c),e=d.content;"url"===e.substr(0,3)&&q.loadImage(l.Util.parseBackgroundImage(e)[0].args[0]),m(d.backgroundImage,b)}function i(a){h(a,":before"),h(a,":after")}function j(a,b){var d=l.Generate.Gradient(a,b);d!==c&&(t[a]={img:d,succeeded:!0},t.numTotal++,t.numLoaded++,f())}function k(a){return a&&a.method&&a.args&&a.args.length>0}function m(a,b){var d;l.Util.parseBackgroundImage(a).filter(k).forEach(function(a){"url"===a.method?q.loadImage(a.args[0]):a.method.match(/\-?gradient$/)&&(d===c&&(d=l.Util.Bounds(b)),j(a.value,d))})}function n(a){var b=!1;try{u.Children(a).forEach(n)}catch(d){}try{b=a.nodeType}catch(e){b=!1,u.log("html2canvas: failed to access some element's nodeType - Exception: "+e.message)}if(1===b||b===c){i(a);try{m(u.getCSS(a,"backgroundImage"),a)}catch(d){u.log("html2canvas: failed to get background-image - Exception: "+d.message)}m(a)}}function o(b,e){b.onload=function(){e.timer!==c&&a.clearTimeout(e.timer),t.numLoaded++,e.succeeded=!0,b.onerror=b.onload=null,f()},b.onerror=function(){if("anonymous"===b.crossOrigin&&(a.clearTimeout(e.timer),d.proxy)){var c=b.src;return b=new Image,e.img=b,b.src=c,void g(b.src,b,e)}t.numLoaded++,t.numFailed++,e.succeeded=!1,b.onerror=b.onload=null,f()}}var p,q,r,s,t={numLoaded:0,numFailed:0,numTotal:0,cleanupDone:!1},u=l.Util,v=0,w=d.elements[0]||b.body,x=w.ownerDocument,y=w.getElementsByTagName("img"),z=y.length,A=x.createElement("a"),B=function(a){return a.crossOrigin!==c}(new Image);for(A.href=a.location.href,p=A.protocol+A.host,q={loadImage:function(a){var b,f;a&&t[a]===c&&(b=new Image,a.match(/data:image\/.*;base64,/i)?(b.src=a.replace(/url\(['"]{0,}|['"]{0,}\)$/gi,""),f=t[a]={img:b},t.numTotal++,o(b,f)):e(a)||d.allowTaint===!0?(f=t[a]={img:b},t.numTotal++,o(b,f),b.src=a):B&&!d.allowTaint&&d.useCORS?(b.crossOrigin="anonymous",f=t[a]={img:b},t.numTotal++,o(b,f),b.src=a):d.proxy&&(f=t[a]={img:b},t.numTotal++,g(a,b,f)))},cleanupDOM:function(e){var g,h;if(!t.cleanupDone){u.log(e&&"string"==typeof e?"html2canvas: Cleanup because: "+e:"html2canvas: Cleanup after timeout: "+d.timeout+" ms.");for(h in t)if(t.hasOwnProperty(h)&&(g=t[h],"object"==typeof g&&g.callbackname&&g.succeeded===c)){a[g.callbackname]=c;try{delete a[g.callbackname]}catch(i){}g.script&&g.script.parentNode&&(g.script.setAttribute("src","about:blank"),g.script.parentNode.removeChild(g.script)),t.numLoaded++,t.numFailed++,u.log("html2canvas: Cleaned up failed img: '"+h+"' Steps: "+t.numLoaded+" / "+t.numTotal)}a.stop!==c?a.stop():b.execCommand!==c&&b.execCommand("Stop",!1),b.close!==c&&b.close(),t.cleanupDone=!0,e&&"string"==typeof e||f()}},renderingDone:function(){s&&a.clearTimeout(s)}},d.timeout>0&&(s=a.setTimeout(q.cleanupDOM,d.timeout)),u.log("html2canvas: Preload starts: finding background-images"),t.firstRun=!0,n(w),u.log("html2canvas: Preload: Finding images"),r=0;z>r;r+=1)q.loadImage(y[r].getAttribute("src"));return t.firstRun=!1,u.log("html2canvas: Preload: Done."),t.numTotal===t.numLoaded&&f(),q},l.Renderer=function(a,d){function e(a){function b(a){Object.keys(a).sort().forEach(function(c){var d=[],f=[],g=[],h=[];a[c].forEach(function(a){a.node.zIndex.isPositioned||a.node.zIndex.opacity<1?g.push(a):a.node.zIndex.isFloated?f.push(a):d.push(a)}),function i(a){a.forEach(function(a){h.push(a),a.children&&i(a.children)})}(d.concat(f,g)),h.forEach(function(a){a.context?b(a.context):e.push(a.node)})})}var d,e=[];return d=function(a){function b(a,d,e){var f="auto"===d.zIndex.zindex?0:Number(d.zIndex.zindex),g=a,h=d.zIndex.isPositioned,i=d.zIndex.isFloated,j={node:d},k=e;d.zIndex.ownStacking?(g=j.context={"!":[{node:d,children:[]}]},k=c):(h||i)&&(k=j.children=[]),0===f&&e?e.push(j):(a[f]||(a[f]=[]),a[f].push(j)),d.zIndex.children.forEach(function(a){b(g,a,k)})}var d={};return b(d,a),d}(a),b(d),e}function f(a){var b;if("string"==typeof d.renderer&&l.Renderer[a]!==c)b=l.Renderer[a](d);else{if("function"!=typeof a)throw new Error("Unknown renderer");b=a(d)}if("function"!=typeof b)throw new Error("Invalid renderer defined");return b}return f(d.renderer)(a,d,b,e(a.stack),l)},l.Util.Support=function(a,b){function d(){var a=new Image,d=b.createElement("canvas"),e=d.getContext===c?!1:d.getContext("2d");if(e===!1)return!1;d.width=d.height=10,a.src=["data:image/svg+xml,","<svg xmlns='http://www.w3.org/2000/svg' width='10' height='10'>","<foreignObject width='10' height='10'>","<div xmlns='http://www.w3.org/1999/xhtml' style='width:10;height:10;'>","sup","</div>","</foreignObject>","</svg>"].join("");try{e.drawImage(a,0,0),d.toDataURL()}catch(f){return!1}return l.Util.log("html2canvas: Parse: SVG powered rendering available"),!0}function e(){var a,c,d,e,f=!1;return b.createRange&&(a=b.createRange(),a.getBoundingClientRect&&(c=b.createElement("boundtest"),c.style.height="123px",c.style.display="block",b.body.appendChild(c),a.selectNode(c),d=a.getBoundingClientRect(),e=d.height,123===e&&(f=!0),b.body.removeChild(c))),f}return{rangeBounds:e(),svgRendering:a.svgRendering&&d()}},a.html2canvas=function(b,c){b=b.length?b:[b];var d,e,f={logging:!1,elements:b,background:"#fff",proxy:null,timeout:0,useCORS:!1,allowTaint:!1,svgRendering:!1,ignoreElements:"IFRAME|OBJECT|PARAM",useOverflow:!0,letterRendering:!1,chinese:!1,width:null,height:null,taintTest:!0,renderer:"Canvas"};return f=l.Util.Extend(c,f),l.logging=f.logging,f.complete=function(a){("function"!=typeof f.onpreloaded||f.onpreloaded(a)!==!1)&&(d=l.Parse(a,f),("function"!=typeof f.onparsed||f.onparsed(d)!==!1)&&(e=l.Renderer(d,f),"function"==typeof f.onrendered&&f.onrendered(e)))},a.setTimeout(function(){l.Preload(f)},0),{render:function(a,b){return l.Renderer(a,l.Util.Extend(b,f))},parse:function(a,b){return l.Parse(a,l.Util.Extend(b,f))},preload:function(a){return l.Preload(l.Util.Extend(a,f))},log:l.Util.log}},a.html2canvas.log=l.Util.log,a.html2canvas.Renderer={Canvas:c},l.Renderer.Canvas=function(a){function d(a,b){a.beginPath(),b.forEach(function(b){a[b.name].apply(a,b.arguments)}),a.closePath()}function e(a){if(-1===h.indexOf(a.arguments[0].src)){j.drawImage(a.arguments[0],0,0);try{j.getImageData(0,0,1,1)}catch(b){return i=g.createElement("canvas"),j=i.getContext("2d"),!1}h.push(a.arguments[0].src)}return!0}function f(b,c){switch(c.type){case"variable":b[c.name]=c.arguments;break;case"function":switch(c.name){case"createPattern":if(c.arguments[0].width>0&&c.arguments[0].height>0)try{b.fillStyle=b.createPattern(c.arguments[0],"repeat")}catch(f){k.log("html2canvas: Renderer: Error creating pattern",f.message)}break;case"drawShape":d(b,c.arguments);break;case"drawImage":c.arguments[8]>0&&c.arguments[7]>0&&(!a.taintTest||a.taintTest&&e(c))&&b.drawImage.apply(b,c.arguments);break;default:b[c.name].apply(b,c.arguments)}}}a=a||{};var g=b,h=[],i=b.createElement("canvas"),j=i.getContext("2d"),k=l.Util,m=a.canvas||g.createElement("canvas");return function(a,b,d,e,g){var h,i,j,l=m.getContext("2d"),n=a.stack;return m.width=m.style.width=b.width||n.ctx.width,m.height=m.style.height=b.height||n.ctx.height,j=l.fillStyle,l.fillStyle=k.isTransparent(n.backgroundColor)&&b.background!==c?b.background:a.backgroundColor,l.fillRect(0,0,m.width,m.height),l.fillStyle=j,e.forEach(function(a){l.textBaseline="bottom",l.save(),a.transform.matrix&&(l.translate(a.transform.origin[0],a.transform.origin[1]),l.transform.apply(l,a.transform.matrix),l.translate(-a.transform.origin[0],-a.transform.origin[1])),a.clip&&(l.beginPath(),l.rect(a.clip.left,a.clip.top,a.clip.width,a.clip.height),l.clip()),a.ctx.storage&&a.ctx.storage.forEach(function(a){f(l,a)}),l.restore()}),k.log("html2canvas: Renderer: Canvas renderer done - returning canvas obj"),1===b.elements.length&&"object"==typeof b.elements[0]&&"BODY"!==b.elements[0].nodeName?(i=g.Util.Bounds(b.elements[0]),h=d.createElement("canvas"),h.width=Math.ceil(i.width),h.height=Math.ceil(i.height),l=h.getContext("2d"),l.drawImage(m,i.left,i.top,i.width,i.height,0,0,i.width,i.height),m=null,h):m}}}(window,document),function(a){function b(){canDraw=!1,a(document).off("mouseenter mouseleave",".user-feedback-helper"),a(document).off("mouseup keyup"),a(document).off("mousedown",".user-feedback-setblackout"),a(document).off("mousedown",".user-feedback-sethighlight"),a(document).off("mousedown click","#user-feedback-close"),a(document).off("mousedown","#user-feedback-canvas"),a(document).off("click","#user-feedback-highlighter-next"),a(document).off("click","#user-feedback-highlighter-back"),a(document).off("click","#user-feedback-welcome-next"),a(document).off("click","#user-feedback-overview-back"),a(document).off("mouseleave","body"),a(document).off("mouseenter",".user-feedback-helper"),a(document).off("selectstart dragstart",document),a("#user-feedback-module").off("click",".user-feedback-wizard-close,.user-feedback-button-close"),a(document).off("click","#user-feedback-submit"),e.highlightElement&&(a(document).off("click","#user-feedback-canvas"),a(document).off("mousemove","#user-feedback-canvas")),a('[data-highlighted="true"]').removeAttr("data-highlight-id").removeAttr("data-highlighted"),a("#user-feedback-module").remove(),a("#user-feedback-init-button").removeClass("hidden")}function c(b,c){c="undefined"!=typeof c?c:!0,b.clearRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),b.fillStyle="rgba(102,102,102,0.5)",b.fillRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&c&&d(b,parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&b.clearRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),a(".user-feedback-helper").each(function(){"blackout"==a(this).attr("data-type")&&(b.fillStyle="rgba(0,0,0,1)",b.fillRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height()))})}function d(a,b,c,d,f){a.strokeStyle=e.strokeStyle,a.shadowColor=e.shadowColor,a.shadowOffsetX=e.shadowOffsetX,a.shadowOffsetY=e.shadowOffsetY,a.shadowBlur=e.shadowBlur,a.lineJoin=e.lineJoin,a.lineWidth=e.lineWidth,a.strokeRect(b,c,d,f),a.shadowOffsetX=0,a.shadowOffsetY=0,a.shadowBlur=0,a.lineWidth=1}var e={ajaxURL:user_feedback.ajax_url,initButtonText:user_feedback.button_text,initialBox:document.cookie.indexOf("user_feedback_dont_show_again")<0,strokeStyle:"black",shadowColor:"black",shadowOffsetX:1,shadowOffsetY:1,shadowBlur:10,lineJoin:"bevel",lineWidth:3,tpl:{description:user_feedback.tpl.description,highlighter:user_feedback.tpl.highlighter,overview:user_feedback.tpl.overview,submitSuccess:user_feedback.tpl.submit_success,submitError:user_feedback.tpl.submit_error}},f=!!window.HTMLCanvasElement;a.event.trigger({type:"user_feedback_load",settings:e,supportedBrowser:f}),f&&(a("body").append('<button id="user-feedback-init-button" class="user-feedback-button user-feedback-button-gray">'+e.initButtonText+"</button>"),a(document).on("click","#user-feedback-init-button",function(){a.event.trigger({type:"user_feedback_init"}),a(this).addClass("hidden");var f=!1,g="",h=a(document).height(),i=a(document).width(),j='<div id="user-feedback-module">';e.initialBox&&(j+=e.tpl.description),j+=e.tpl.highlighter+e.tpl.overview+'<canvas id="user-feedback-canvas"></canvas><div id="user-feedback-helpers"></div><input id="user-feedback-note" name="user-feedback-note" type="hidden"></div>',a("body").append(j),canvasAttr={width:i,height:h},a("#user-feedback-canvas").attr(canvasAttr).css("z-index","30000"),e.initialBox||(a("#user-feedback-highlighter-back").remove(),f=!0,a("#user-feedback-canvas").css("cursor","crosshair"),a("#user-feedback-helpers").removeClass("hidden"),a("#user-feedback-welcome").addClass("hidden"),a("#user-feedback-highlighter").removeClass("hidden"));var k=a("#user-feedback-canvas")[0].getContext("2d");k.fillStyle="rgba(102,102,102,0.5)",k.fillRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),rect={},drag=!1,highlight=1,post={},navigator.sayswho=function(){var a,b=navigator.userAgent,c=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(c[1])?(a=/\brv[ :]+(\d+)/g.exec(b)||[],"Internet Explorer "+(a[1]||"")):"Chrome"===c[1]&&(a=b.match(/\bOPR\/(\d+)/),null!=a)?"Opera "+a[1]:(c=c[2]?[c[1],c[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(a=b.match(/version\/(\d+)/i))&&c.splice(1,1,a[1]),c.join(" "))}(),a("#user-feedback-additional-theme").append(" <span>"+user_feedback.theme.name+"</span>"),a("#user-feedback-additional-browser").append(" <span>"+navigator.sayswho+"</span>"),a("#user-feedback-additional-template").append(" <span>"+user_feedback.theme.current_template+"</span>"),a("#user-feedback-additional-language").append(" <span>"+user_feedback.language+"</span>"),post.browser={},post.browser.name=navigator.sayswho,post.browser.cookieEnabled=navigator.cookieEnabled,post.browser.platform=navigator.platform,post.browser.userAgent=navigator.userAgent,post.url=document.URL,post.theme=user_feedback.theme,post.language=user_feedback.language,post.user={},a(document).on("mousedown","#user-feedback-canvas",function(b){f&&(rect.startX=b.pageX-a(this).offset().left,rect.startY=b.pageY-a(this).offset().top,rect.w=0,rect.h=0,drag=!0)}),a(document).on("mouseup",function(){if(f){drag=!1;var b=rect.startY,d=rect.startX,e=rect.w,g=rect.h;if(dtype="highlight",0==e||0==g)return;0>e&&(d+=e,e*=-1),0>g&&(b+=g,g*=-1),b+g>a(document).height()&&(g=a(document).height()-b),d+e>a(document).width()&&(e=a(document).width()-d),0==highlight&&(dtype="blackout"),a("#user-feedback-helpers").append('<div class="user-feedback-helper" data-type="'+dtype+'" data-time="'+Date.now()+'" style="position:absolute;top:'+b+"px;left:"+d+"px;width:"+e+"px;height:"+g+'px;z-index:30000;"></div>'),c(k),rect.w=0}}),a(document).on("mousemove",function(b){f&&drag&&(a("#user-feedback-highlighter").css("cursor","default"),rect.w=b.pageX-a("#user-feedback-canvas").offset().left-rect.startX,rect.h=b.pageY-a("#user-feedback-canvas").offset().top-rect.startY,k.clearRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),k.fillStyle="rgba(102,102,102,0.5)",k.fillRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&d(k,parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),1==highlight&&(d(k,rect.startX,rect.startY,rect.w,rect.h),k.clearRect(rect.startX,rect.startY,rect.w,rect.h)),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&k.clearRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),a(".user-feedback-helper").each(function(){"blackout"==a(this).attr("data-type")&&(k.fillStyle="rgba(0,0,0,1)",k.fillRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height()))}),0==highlight&&(k.fillStyle="rgba(0,0,0,0.5)",k.fillRect(rect.startX,rect.startY,rect.w,rect.h)),a.event.trigger({type:"user_feedback_highlight",context:k,type:1==highlight?"highlight":"blackout"}))});var l=[],m=[],n=0;a(document).on("mousemove click","#user-feedback-canvas",function(b){if(f){c(k),m=[],a("#user-feedback-canvas").css("cursor","crosshair"),a("* :not(body,script,iframe,div,section,.user-feedback-button,#user-feedback-module *)").each(function(){"true"!==a(this).attr("data-highlighted")&&b.pageX>a(this).offset().left&&b.pageX<a(this).offset().left+a(this).width()&&b.pageY>a(this).offset().top+parseInt(a(this).css("padding-top"),10)&&b.pageY<a(this).offset().top+a(this).height()+parseInt(a(this).css("padding-top"),10)&&m.push(a(this))});var e=m[m.length-1];if(e&&!drag){a("#user-feedback-canvas").css("cursor","pointer");var g=e.offset().left-2,h=e.offset().top-2,i=e.width()+parseInt(e.css("padding-left"),10)+parseInt(e.css("padding-right"),10)+6,j=e.height()+parseInt(e.css("padding-top"),10)+parseInt(e.css("padding-bottom"),10)+6;1==highlight&&(d(k,g,h,i,j),k.clearRect(g,h,i,j),dtype="highlight"),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&k.clearRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),0==highlight&&(dtype="blackout",k.fillStyle="rgba(0,0,0,0.5)",k.fillRect(g,h,i,j)),a(".user-feedback-helper").each(function(){"blackout"==a(this).attr("data-type")&&(k.fillStyle="rgba(0,0,0,1)",k.fillRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height()))}),"click"==b.type&&b.pageX==rect.startX&&b.pageY==rect.startY&&(a("#user-feedback-helpers").append('<div class="user-feedback-helper" data-highlight-id="'+n+'" data-type="'+dtype+'" data-time="'+Date.now()+'" style="position:absolute;top:'+h+"px;left:"+g+"px;width:"+i+"px;height:"+j+'px;z-index:30000;"></div>'),l.push(n),++n,c(k))}}}),a(document).on("mouseleave","body,#user-feedback-canvas",function(){c(k)}),a(document).on("mouseenter",".user-feedback-helper",function(){c(k)}),a(document).on("click","#user-feedback-welcome-next",function(){a("#user-feedback-note-tmp").val().length>0?(f=!0,a("#user-feedback-canvas").css("cursor","crosshair"),a("#user-feedback-helpers").addClass("hidden"),a("#user-feedback-welcome").addClass("hidden"),a("#user-feedback-highlighter").removeClass("hidden"),a("#user-feedback-overview-note").val(a("#user-feedback-note-tmp").val()),"undefined"!=a("#user-feedback-user-name").val()&&(a("#user-feedback-overview-user span span").text(a("#user-feedback-user-name").val()),post.user.name=a("#user-feedback-user-name").val()),"undefined"!=a("#user-feedback-user-email").val()&&(a("#user-feedback-overview-user img").attr("src","https://secure.gravatar.com/avatar/"+md5(a("#user-feedback-user-email").val())+"?s=90"),post.user.email=a("#user-feedback-user-email").val())):a("#user-feedback-welcome-error").removeClass("hidden")}),a(document).on("mouseenter mouseleave",".user-feedback-helper",function(b){drag||(rect.w=0,rect.h=0,"mouseenter"===b.type?(a(this).css("z-index","30001"),a(this).append('<div class="user-feedback-helper-inner" style="width:'+(a(this).width()-2)+"px;height:"+(a(this).height()-2)+'px;position:absolute;margin:1px;"></div>'),a(this).append('<div id="user-feedback-close"></div>'),a(this).find("#user-feedback-close").css({top:-1*(a(this).find("#user-feedback-close").height()/2)+"px",left:a(this).width()-a(this).find("#user-feedback-close").width()/2+"px"}),"blackout"==a(this).attr("data-type")&&(k.clearRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),k.fillStyle="rgba(102,102,102,0.5)",k.fillRect(0,0,a("#user-feedback-canvas").width(),a("#user-feedback-canvas").height()),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&d(k,parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),a(".user-feedback-helper").each(function(){"highlight"==a(this).attr("data-type")&&k.clearRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())}),k.clearRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height()),k.fillStyle="rgba(0,0,0,0.75)",k.fillRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height()),ignore=a(this).attr("data-time"),a(".user-feedback-helper").each(function(){return a(this).attr("data-time")==ignore?!0:void("blackout"==a(this).attr("data-type")&&(k.fillStyle="rgba(0,0,0,1)",k.fillRect(parseInt(a(this).css("left"),10),parseInt(a(this).css("top"),10),a(this).width(),a(this).height())))}))):(a(this).css("z-index","30000"),a(this).children().remove(),"blackout"==a(this).attr("data-type")&&c(k)))}),a(document).on("click","#user-feedback-close",function(){if(e.highlightElement&&a(this).parent().attr("data-highlight-id"))var b=a(this).parent().attr("data-highlight-id");a(this).parent().remove(),e.highlightElement&&b&&a('[data-highlight-id="'+b+'"]').removeAttr("data-highlighted").removeAttr("data-highlight-id"),c(k)}),a("#user-feedback-module").on("click",".user-feedback-wizard-close,.user-feedback-button-close",function(){b()}),a(document).on("keyup",function(a){27==a.keyCode&&b()}),a(document).on("selectstart dragstart",document,function(a){a.preventDefault()}),a(document).on("click","#user-feedback-highlighter-back",function(){f=!1,a("#user-feedback-canvas").css("cursor","default"),a("#user-feedback-helpers").addClass("hidden"),a("#user-feedback-highlighter").addClass("hidden"),a("#user-feedback-welcome-error").addClass("hidden"),a("#user-feedback-welcome").removeClass("hidden")}),a(document).on("mousedown",".user-feedback-sethighlight",function(){highlight=1,a(this).addClass("user-feedback-active"),a(".user-feedback-setblackout").removeClass("user-feedback-active")}),a(document).on("mousedown",".user-feedback-setblackout",function(){highlight=0,a(this).addClass("user-feedback-active"),a(".user-feedback-sethighlight").removeClass("user-feedback-active")}),a(document).on("click","#user-feedback-highlighter-next",function(){f=!1,a("#user-feedback-canvas").css("cursor","default");var b=a(document).scrollTop(),d=a(window).height();a("#user-feedback-helpers").addClass("hidden"),a("#user-feedback-highlighter").addClass("hidden"),html2canvas(a("body"),{onrendered:function(f){e.screenshotStroke||c(k),_canvas=a('<canvas id="user-feedback-canvas-tmp" width="'+i+'" height="'+d+'"/>').hide().appendTo("body"),_ctx=_canvas.get(0).getContext("2d"),_ctx.drawImage(f,0,b,i,d,0,0,i,d),g=_canvas.get(0).toDataURL(),a(document).scrollTop(b),post.img=g,a("#user-feedback-canvas-tmp").remove(),a("#user-feedback-overview").toggleClass("hidden"),a("user-feedback-overview-note").val(a("#user-feedback-note").val()),a("#user-feedback-overview-screenshot-img").attr("src",g),a("#user-feedback-screenshot-size span").remove(),a("#user-feedback-screenshot-size").append(" <span>"+a("#user-feedback-overview-screenshot-img")[0].naturalWidth+"x"+a("#user-feedback-overview-screenshot-img")[0].naturalHeight+"</span>"),a("#user-feedback-screenshot-highlighted span").remove(),a("#user-feedback-screenshot-highlighted").append(a(".user-feedback-helper").length<=1?" <span>"+a(".user-feedback-helper").length+" "+a("#user-feedback-screenshot-highlighted").attr("data-single")+"</span>":" <span>"+a(".user-feedback-helper").length+" "+a("#user-feedback-screenshot-highlighted").attr("data-multiple")+"</span>")}})}),a(document).on("click","#user-feedback-overview-back",function(){f=!0,a("#user-feedback-canvas").css("cursor","crosshair"),a("#user-feedback-overview").addClass("hidden"),a("#user-feedback-helpers").removeClass("hidden"),a("#user-feedback-highlighter").removeClass("hidden"),a("#user-feedback-overview-error").addClass("hidden"),a("#user-feedback-note-tmp").val(a("#user-feedback-overview-note").val())}),a(document).on("click","#user-feedback-submit",function(){f=!1,a("#user-feedback-overview-note").val().length>0?(a("#user-feedback-submit-success,#user-feedback-submit-error").remove(),a("#user-feedback-overview").addClass("hidden"),post.img=g,post.note=a("#user-feedback-overview-note").val(),a.post(e.ajaxURL,{action:"user_feedback",data:post},function(){var b=new Date;b.setDate(b.getDate()+30),document.cookie="user_feedback_dont_show_again=1; path=/;expires="+b.toUTCString(),a("#user-feedback-module").append(e.tpl.submitSuccess)}).fail(function(){a("#user-feedback-module").append(e.tpl.submitError)})):a("#user-feedback-overview-error").removeClass("hidden")})}))}(jQuery);
